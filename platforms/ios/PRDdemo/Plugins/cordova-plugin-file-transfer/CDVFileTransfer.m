...
- (void)cancelTransfer:(NSURLConnection*)connection
{
    ...
    // // [self removeTargetFile]; /*Commented for PRD by LuoWen*/ /*Commented for PRD by LuoWen*/
}
...
- (void)connection:(NSURLConnection*)connection didReceiveResponse:(NSURLResponse*)response
{
    ...
    if ((self.direction == CDV_TRANSFER_DOWNLOAD) && (self.responseCode >= 200) && (self.responseCode < 300)) {
		...
		// /*Commented for PRD by LuoWen*/ if ([[NSFileManager defaultManager] fileExistsAtPath:filePath] == NO) { 
